...
# join data ------
acs_fy12_fy22_elementary_raw <- bind_rows(
...
# clean -------
acs_fy12_fy22_elementary <- acs_fy12_fy22_elementary_raw |>
  rename(
    ncesid = "GEOID",
    dist_name = NAME
  ) |>
...
# write data -----
write_rds(acs_fy12_fy22_elementary, "data/processed/acs_fy12_fy22_elementary.rds")
