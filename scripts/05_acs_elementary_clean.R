...
# join data ------
acs_fy12_fy23_elementary_raw <- bind_rows(
...
# clean -------
acs_fy12_fy23_elementary <- acs_fy12_fy23_elementary_raw |>
  rename(
    ncesid = "GEOID",
    dist_name = NAME
  ) |>
...
# write data -----
write_rds(acs_fy12_fy23_elementary, "data/processed/acs_fy12_fy23_elementary.rds")
