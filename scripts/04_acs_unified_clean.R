...
# join data ------
acs_fy12_fy22_unified_raw <- bind_rows(
...
# clean -------
acs_fy12_fy22_unified <- acs_fy12_fy22_unified_raw |>
  rename(
    ncesid = "GEOID",
    dist_name = NAME
  ) |>
...
# export data -----
write_rds(acs_fy12_fy22_unified, "data/processed/acs_fy12_fy22_unified.rds")
